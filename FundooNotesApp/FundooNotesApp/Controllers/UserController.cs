...
namespace FundooNotesApp.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [HttpPut]
        [Route("ResetPassword")]
        public IActionResult ResetPasswaord(ResetModel resetModel)
        {
            try
            {
        ...
        public IActionResult ForgetPassword(string EmailId,MsmqModel msmqModel)
        {
            try
            {
                var result = iuserBL.ForgetPaasword(EmailId, msmqModel);
                if (result != false)
                {
